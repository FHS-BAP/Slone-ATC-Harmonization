# ******************************************************************************************************************************************
# Introduction to Gen 2/Omni 1 Exam 8-10 Steroids drug usage ATC/Slone conversion source code
# ******************************************************************************************************************************************
#   
...
# 
# 
# The purpose of this R code is to convert the steroid ATC codes in the Gen 2/Omni 1 Exam 8-10 ATC datasets
...
#Join ATC and Slone
steroid_08_1b_joined <- inner_join(cod_08_1b, steroid_a_s, by = c("medname", "atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))

#remove older atc columns
steroid_08_1b_corrected <- steroid_08_1b_joined[ , !(names(steroid_08_1b_joined) %in% c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))]

#rename to correct columns to just atc
colnames(steroid_08_1b_corrected)[5:8] <- c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4")

#reorder rows
steroid_08_1b_ordered <- steroid_08_1b_corrected %>% arrange(framid)

#add exam number
steroid_08_1b_ordered$exam_num <- 8
steroid_08_1b_final <- steroid_08_1b_ordered %>% relocate(exam_num, .before = id)
...
#Join ATC and Slone
steroid_09_1b_joined <- inner_join(cod_09_1b, steroid_a_s, by = c("medname", "atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))

#remove older atc columns
steroid_09_1b_corrected <- steroid_09_1b_joined[ , !(names(steroid_09_1b_joined) %in% c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))]

#rename to correct columns to just atc
colnames(steroid_09_1b_corrected)[5:8] <- c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4")

#reorder rows
steroid_09_1b_ordered <- steroid_09_1b_corrected %>% arrange(framid)

#add exam number
steroid_09_1b_ordered$exam_num <- 9
steroid_09_1b_final <- steroid_09_1b_ordered %>% relocate(exam_num, .before = id)
...
#Join ATC and Slone
steroid_10_1b_joined <- inner_join(cod_10_1b, steroid_a_s_4_removed, by = c("medname", "atc_cod1", "atc_cod2", "atc_cod3"))

#remove older atc columns
steroid_10_1b_corrected <- steroid_10_1b_joined[ , !(names(steroid_10_1b_joined) %in% c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))]

#rename to correct columns to just atc
colnames(steroid_10_1b_corrected)[5:8] <- c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4")

#reorder rows
steroid_10_1b_ordered <- steroid_10_1b_corrected %>% arrange(framid)

#add exam number
steroid_10_1b_ordered$exam_num <- 10
steroid_10_1b_final <- steroid_10_1b_ordered %>% relocate(exam_num, .before = id)


#### Final Section ####
steroid_full_final <- bind_rows(steroid_08_1b_final, steroid_09_1b_final, steroid_10_1b_final)
#write final CSV to file
write.csv(steroid_full_final, file = "Slone_ATC_Steroid_Gen_2_Omni_1_Full.csv", row.names = FALSE)
