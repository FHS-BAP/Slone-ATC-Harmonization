# ******************************************************************************************************************************************
# Introduction to Gen 2/Omni 1 Exam 8-10 Hormones drug usage ATC/Slone conversion source code
# ******************************************************************************************************************************************
#   
...
# 
# 
# The purpose of this R code is to convert the hormone ATC codes in the Gen 2/Omni 1 Exam 8-10 ATC datasets
...
#Join ATC and Slone
hormone_08_1b_joined <- inner_join(cod_08_1b, hormone_a_s, by = c("medname", "atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))

#remove older atc columns
hormone_08_1b_corrected <- hormone_08_1b_joined[ , !(names(hormone_08_1b_joined) %in% c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))]

#rename to correct columns to just atc
colnames(hormone_08_1b_corrected)[5:8] <- c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4")

#reorder rows
hormone_08_1b_ordered <- hormone_08_1b_corrected %>% arrange(framid)

#add exam number
hormone_08_1b_ordered$exam_num <- 8
hormone_08_1b_final <- hormone_08_1b_ordered %>% relocate(exam_num, .before = id)
...
#Join ATC and Slone
hormone_09_1b_joined <- inner_join(cod_09_1b, hormone_a_s, by = c("medname", "atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))

#remove older atc columns
hormone_09_1b_corrected <- hormone_09_1b_joined[ , !(names(hormone_09_1b_joined) %in% c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))]

#rename to correct columns to just atc
colnames(hormone_09_1b_corrected)[5:8] <- c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4")

#reorder rows
hormone_09_1b_ordered <- hormone_09_1b_corrected %>% arrange(framid)

#add exam number
hormone_09_1b_ordered$exam_num <- 9
hormone_09_1b_final <- hormone_09_1b_ordered %>% relocate(exam_num, .before = id)
...
#Join ATC and Slone
hormone_10_1b_joined <- inner_join(cod_10_1b, hormone_a_s_4_removed, by = c("medname", "atc_cod1", "atc_cod2", "atc_cod3"))

#remove older atc columns
hormone_10_1b_corrected <- hormone_10_1b_joined[ , !(names(hormone_10_1b_joined) %in% c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4"))]

#rename to correct columns to just atc
colnames(hormone_10_1b_corrected)[5:8] <- c("atc_cod1", "atc_cod2", "atc_cod3", "atc_cod4")

#reorder rows
hormone_10_1b_ordered <- hormone_10_1b_corrected %>% arrange(framid)

#add exam number
hormone_10_1b_ordered$exam_num <- 10
hormone_10_1b_final <- hormone_10_1b_ordered %>% relocate(exam_num, .before = id)


#### Final Section ####
hormone_full_final <- bind_rows(hormone_08_1b_final, hormone_09_1b_final, hormone_10_1b_final)
#write final CSV to file
write.csv(hormone_full_final, file = "Slone_ATC_Hormone_Gen_2_Omni_1_Full.csv", row.names = FALSE)
