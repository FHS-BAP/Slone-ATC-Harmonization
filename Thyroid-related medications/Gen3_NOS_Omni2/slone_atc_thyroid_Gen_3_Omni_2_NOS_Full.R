...
thyroid_filtered_01_3b <- cod_01_3b %>% filter_all(any_vars(. %in% thyroid_atc_list))
...
thyroid_01_3b_join_multiple <- left_join(thyroid_multiple_01_3b, thyroid_a_s_armour, by = c("atc_cod1", "atc_cod2")) #armour thyroid
...
#Select the rows of individual ATC data containing the specific ATC numbers in the lists for drugs of this type
thyroid_filtered_02_3b <- cod_02_3b %>% filter_all(any_vars(. %in% thyroid_atc_list))
...
#Match multiple ATCs to one Slone - specific drugs mentioned above
thyroid_02_3b_join_multiple <- left_join(thyroid_multiple_02_3b, thyroid_a_s_armour, by = c("atc_cod1", "atc_cod2")) #armour thyroid
...
#Select the rows of individual ATC data containing the specific ATC numbers in the lists for drugs of this type
thyroid_filtered_03_3b <- cod_03_3b %>% filter_all(any_vars(. %in% thyroid_atc_list))
...
#Match multiple ATCs to one Slone - specific drugs mentioned above
thyroid_03_3b_join_multiple <- left_join(thyroid_multiple_03_3b, thyroid_a_s_armour, by = c("atc_cod1", "atc_cod2")) #armour thyroid
