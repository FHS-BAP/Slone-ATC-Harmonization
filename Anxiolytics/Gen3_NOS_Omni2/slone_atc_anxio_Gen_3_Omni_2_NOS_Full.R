# ******************************************************************************************************************************************
# Introduction to Gen 3/Omni 2/NOS Exam 1-3 Anxiolytics drug usage ATC/Slone conversion source code
# ******************************************************************************************************************************************
#   
...
# 
# 
# The purpose of this R code is to convert the anxiolytics ATC codes in the Gen 3/Omni 2/NOS Exam 3 Exam 1-3 ATC datasets
...
anxio_filtered_01_3b <- cod_01_3b %>% filter_all(any_vars(. %in% anxio_atc_list))

#rows with only one ATC code
anxio_single_01_3b <- anxio_filtered_01_3b[nchar(anxio_filtered_01_3b$atc_cod2) == 0 
                                           & nchar(anxio_filtered_01_3b$atc_cod3) == 0
                                           & nchar(anxio_filtered_01_3b$atc_cod4) == 0, ]

#rows with multiple ATC codes
anxio_multiple_01_3b <- anxio_filtered_01_3b[nchar(anxio_filtered_01_3b$atc_cod2) > 0 
                                             | nchar(anxio_filtered_01_3b$atc_cod3) > 0
                                             | nchar(anxio_filtered_01_3b$atc_cod4) > 0, ]

#Match multiple ATCs to one Slone
anxio_01_3b_join_multiple <- inner_join(anxio_multiple_01_3b, anxio_a_s_multiple, by = c("atc_cod1", "atc_cod2"))
...
anxio_01_3b_join_1 <- left_join(anxio_single_01_3b, anxio_a_s_single_1, by = "atc_cod1") #carry out merge
#match second ATC column
anxio_01_3b_join_2 <- left_join(anxio_01_3b_join_1, anxio_a_s_single_2, by = "atc_cod2") #carry out merge
#match third ATC column
anxio_01_3b_join_3 <- left_join(anxio_01_3b_join_2, anxio_a_s_single_3, by = "atc_cod3") #carry out merge
#match fourth ATC column
anxio_01_3b_join_4 <- left_join(anxio_01_3b_join_3, anxio_a_s_single_4, by = "atc_cod4") #carry out merge

#bind single atc and multiple atc rows together
anxio_01_3b_bind <- bind_rows(anxio_01_3b_join_4, anxio_01_3b_join_multiple)

#reorder rows
anxio_01_3b_ordered <- anxio_01_3b_bind %>% arrange(framid)

#add exam number
anxio_01_3b_ordered$exam_num <- 1
anxio_01_3b_final <- anxio_01_3b_ordered %>% relocate(exam_num, .before = id)
...
#Select the rows of individual ATC data containing the specific ATC numbers in the lists for drugs of this type
anxio_filtered_02_3b <- cod_02_3b %>% filter_all(any_vars(. %in% anxio_atc_list))

#rows with only one ATC code
anxio_single_02_3b <- anxio_filtered_02_3b[nchar(anxio_filtered_02_3b$atc_cod2) == 0 
                                           & nchar(anxio_filtered_02_3b$atc_cod3) == 0
                                           & nchar(anxio_filtered_02_3b$atc_cod4) == 0, ]

#rows with multiple ATC codes
anxio_multiple_02_3b <- anxio_filtered_02_3b[nchar(anxio_filtered_02_3b$atc_cod2) > 0 
                                             | nchar(anxio_filtered_02_3b$atc_cod3) > 0
                                             | nchar(anxio_filtered_02_3b$atc_cod4) > 0, ]

#Match multiple ATCs to one Slone
anxio_02_3b_join_multiple <- inner_join(anxio_multiple_02_3b, anxio_a_s_multiple, by = c("atc_cod1", "atc_cod2"))

#Match the four ATC columns
#In rows without data for that column or with values not in the drug category the merge will go through but produce a blank result
#match first ATC column
anxio_02_3b_join_1 <- left_join(anxio_single_02_3b, anxio_a_s_single_1, by = "atc_cod1") #carry out merge
#match second ATC column
anxio_02_3b_join_2 <- left_join(anxio_02_3b_join_1, anxio_a_s_single_2, by = "atc_cod2") #carry out merge
#match third ATC column
anxio_02_3b_join_3 <- left_join(anxio_02_3b_join_2, anxio_a_s_single_3, by = "atc_cod3") #carry out merge
#match fourth ATC column
anxio_02_3b_join_4 <- left_join(anxio_02_3b_join_3, anxio_a_s_single_4, by = "atc_cod4") #carry out merge

#bind single atc and multiple atc rows together
anxio_02_3b_bind <- bind_rows(anxio_02_3b_join_4, anxio_02_3b_join_multiple)

#reorder rows
anxio_02_3b_ordered <- anxio_02_3b_bind %>% arrange(framid)

#add exam number
anxio_02_3b_ordered$exam_num <- 2
anxio_02_3b_final <- anxio_02_3b_ordered %>% relocate(exam_num, .before = id)
...
#Select the rows of individual ATC data containing the specific ATC numbers in the lists for drugs of this type
anxio_filtered_03_3b <- cod_03_3b %>% filter_all(any_vars(. %in% anxio_atc_list))

#rows with only one ATC code
anxio_single_03_3b <- anxio_filtered_03_3b[nchar(anxio_filtered_03_3b$atc_cod2) == 0 
                                           & nchar(anxio_filtered_03_3b$atc_cod3) == 0, ]

#rows with multiple ATC codes
anxio_multiple_03_3b <- anxio_filtered_03_3b[nchar(anxio_filtered_03_3b$atc_cod2) > 0 
                                             | nchar(anxio_filtered_03_3b$atc_cod3) > 0, ]

#Match multiple ATCs to one Slone
anxio_03_3b_join_multiple <- inner_join(anxio_multiple_03_3b, anxio_a_s_multiple, by = c("atc_cod1", "atc_cod2"))

#Match the four ATC columns
#In rows without data for that column or with values not in the drug category the merge will go through but produce a blank result
#match first ATC column
anxio_03_3b_join_1 <- left_join(anxio_single_03_3b, anxio_a_s_single_1, by = "atc_cod1") #carry out merge
#match second ATC column
anxio_03_3b_join_2 <- left_join(anxio_03_3b_join_1, anxio_a_s_single_2, by = "atc_cod2") #carry out merge
#match third ATC column
anxio_03_3b_join_3 <- left_join(anxio_03_3b_join_2, anxio_a_s_single_3, by = "atc_cod3") #carry out merge

#bind single atc and multiple atc rows together
anxio_03_3b_bind <- bind_rows(anxio_03_3b_join_3, anxio_03_3b_join_multiple)

#reorder rows
anxio_03_3b_ordered <- anxio_03_3b_bind %>% arrange(framid)

#add exam number
anxio_03_3b_ordered$exam_num <- 3
anxio_03_3b_final <- anxio_03_3b_ordered %>% relocate(exam_num, .before = id)


#### Final Section ####

#bind data frames for each exam
anxio_full_final <- bind_rows(anxio_01_3b_final, anxio_02_3b_final, anxio_03_3b_final)
#write final CSV to file
write.csv(anxio_full_final, file = "Slone_ATC_Anxio_Gen_3_Omni_2_NOS_Full.csv", row.names = FALSE)
